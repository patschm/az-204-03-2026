    ...
    public abstract class DemoBase
    {
        ...
        protected async Task<ResponseToken?> ExtractTokenAsync(HttpResponseMessage response)
        {
            if (response.IsSuccessStatusCode)
            {
                ...
                var jresult = JsonConvert.DeserializeObject(res) as JObject;
        ...
        protected async Task CallGraphApi(string accessToken, string path = "me")
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var jresult = JsonConvert.DeserializeObject(json) as JObject;
                foreach (var child in jresult?.Properties()!)
                {
